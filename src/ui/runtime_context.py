...
def build_runtime_context(
    *, camera_running: bool, fps: float, model_loaded: bool,
    ...
    laser_ai_guidance_enabled: bool = False,
    laser_guidance_session: dict[str, Any] | None = None,
    ...
    context = {
        ...
        "vision": {
            ...
            "laser_ai_guidance_enabled": bool(laser_ai_guidance_enabled),
            "laser_guidance_session": laser_guidance_session or {},
